...
public class AddUmum extends AppCompatActivity {
    ...
    String urlGet = "";
    Toolbar toolbar;
    TextInputEditText nama, info1, info2, info3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_umum);
        ...
        simpan_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (info1.getText().toString().length() == 0) {
                    info1.setError("Tidak boleh kosong");
                    isValid = false;
                }
                if (info2.getText().toString().length() == 0) {
                    info2.setError("Tidak boleh kosong");
                    isValid = false;
                }
                if (info3.getText().toString().length() == 0) {
                    info3.setError("Tidak boleh kosong");
                    isValid = false;
                }

                if (isValid) {
                    String url = new Konfigurasi().baseUrlSimpanUmum() + "simpan_" + urlPlus;
                    ...
                    StringRequest stringRequest=new StringRequest(
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if (status.equals("data tersimpan"))
                                        {
                                            ...
                                            AlertDialog.Builder builder=new AlertDialog.Builder(AddUmum.this);
                        ...
                        public void onErrorResponse(VolleyError error) {
                            progressBar.setVisibility(View.INVISIBLE);
                            Toast.makeText(AddUmum.this, "Pilih Foto", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ){
                        @Nullable
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            form.put("info1", info1.getText().toString());
                            form.put("info2", info2.getText().toString());
                            form.put("info3", info3.getText().toString());
    ...
    void getData()
    {
        String url=new Konfigurasi().baseUrlGetUmum()+"get_" + urlGet;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            String glokasi=jsonObject.getString("info1");
                            String gtanggal=jsonObject.getString("info2");
                            String gdeskripsi=jsonObject.getString("info3");
                            ...
                            nama.setText(gnama);
                            info1.setText(glokasi);
                            info2.setText(gtanggal);
                            info3.setText(gdeskripsi);

                            // Load the old image into the ImageView
                            Glide.with(AddUmum.this).load(urlimage).into(fotoiv);
